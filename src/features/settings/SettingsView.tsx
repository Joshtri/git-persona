...
export function SettingsView() {
  ...
  return (
    <>
          ...
          <div className="rounded-(--radius-xl) bg-(--color-surface) border border-(--color-border) px-4 overflow-hidden">
            ...
            >
              <Switch
                ...
                onCheckedChange={(v) => setValue("show_audit_log", v)}
              />
            </SettingRow>
            <SettingRow
      ...
      >
        {blockedNav !== null && (
          <Dialog.Content title="Unsaved changes" hideClose className="max-w-xs">
              ...
              <div className="flex items-start gap-3">
                <span className="mt-0.5 flex size-8 shrink-0 items-center justify-center rounded-full bg-(--color-warning)/15">
                  <CircleExclamationFill
                    className="size-4 text-(--color-warning)"
                    aria-hidden="true"
                  />
                </span>
                <p className="text-sm text-(--color-secondary) leading-relaxed">
                  Your settings haven't been saved yet. Save before leaving, or your changes will be
                  lost.
                </p>
              </div>
